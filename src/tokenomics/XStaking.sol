...
contract XStaking is Controllable, ReentrancyGuardUpgradeable, IXStaking {
    ...
    function _syncUser(XStakingStorage storage $, IStabilityDAO dao, address user_, uint threshold) internal {
    ...
    function getDAO() internal view returns (IStabilityDAO) {
