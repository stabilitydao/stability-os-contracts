...
contract HostLifeCycleTest is Test, HostUtilsLib {
    ...
    function testLifeCycle56() public {
        ...
        IHost os56 = HostUtilsLib.createHostInstance(vm, MULTISIG, new AccessManager(MULTISIG));
    ...
    function lifeCycleDaoAlien56(IHost host_) internal {
...
//        {
//            host_.changePhase(daoData.symbol);
//            IDAOData.DaoDataView memory daoDataAfter = host_.getDAO(daoData.symbol);
//
...
//
//            IDAOData.DaoDataView memory daoAfter = host_.getDAO("ALIENS");
...
//        }
    ...
    function lifeCycleDaoApes1(IHost host_) internal {
        address asset = host_.getChainSettings().exchangeAsset;
...
//            host_.updateUnits(daoData.symbol, units);
    ...
    function lifeCycleDaoMachines10(IHost host_) internal {
        address asset = host_.getChainSettings().exchangeAsset;
...
//            });
     ...
     */
    function lifeCycleWithSalt(IHost host_) internal {
        address asset = host_.getChainSettings().exchangeAsset;
...
//            });
        ...
        {
// todo
//            IDAOMetadata.sol.UnitUiLink[] memory ui = new IDAOMetadata.sol.UnitUiLink[](1);
//            ui[0] = IDAOMetadata.sol.UnitUiLink({href: "https://mvp.ui", title: "OS MVO"});
//
//            IDAOMetadata.sol.UnitInfo[] memory units = new IDAOMetadata.sol.UnitInfo[](1);
//            units[0].metaData = IDAOMetadata.sol.UnitMetaData({
//                name: daoData.units[0].name,
//                status: IDAOMetadata.sol.UnitStatus.LIVE_2,
...
//            });
//            units[0].chainData = IDAOMetadata.sol.UnitChainData({
//                unitId: daoData.units[0].unitId,
//                developerUid: ""
//            });
//            host_.updateUnits(daoData.symbol, units);
